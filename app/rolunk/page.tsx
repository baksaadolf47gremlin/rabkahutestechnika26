...
export const metadata: Metadata = {
  title: "Rólunk | Rabka Hűtéstechnika",
  description: "Ismerje meg a Rabka Hűtéstechnika csapatát, történetét és értékeit.",
};
...
export default function RolunkPage() {
  return <ComingSoonPage title="Rólunk" features={FEATURES} />;
}

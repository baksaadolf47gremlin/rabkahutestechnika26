...
export const metadata: Metadata = {
  title: "Szolgáltatásaink | Rabka Hűtéstechnika",
  description: "Klíma telepítés, beüzemelés, szervizelés és épületgépészeti megoldások.",
};
...
export default function SzolgaltatasainkPage() {
  return <ComingSoonPage title="Szolgáltatásaink" features={FEATURES} />;
}
